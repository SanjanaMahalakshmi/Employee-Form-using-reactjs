            ...
            <div className="container mt-5">
                ...
                <form onSubmit={handleSubmit} noValidate>
                    <div className="row g-3">
                        ...
                        <div className="col-md-4">
                            <label htmlFor="billableHours" className="form-label">
                                Billable Hours
                            </label>
                            <input
                                type="number"
                        ...
                        <div className="col-md-4">
                            <label className="check form-check-label" htmlFor="isBillable">
                                Billable?
                            </label>
                            <input
                            
                                type="checkbox"
                                className="check1 form-check-input"
                                id="isBillable"
                                name="isBillable"
                ...
                <button type="submit" className="button btn btn-primary mt-4"onClick={handleSubmit} >
                Submit
            </button>
